...
model_classic_CNN.add(Rescaling(1./255,input_shape=img_shape))
model_classic_CNN.add(keras.layers.Conv2D(120,kernel_size=(5,5),input_shape=(img_shape),activation='sigmoid'))
model_classic_CNN.add(keras.layers.MaxPool2D(pool_size=(2,2),strides=(2,2)))
...
model_classic_CNN.add(keras.layers.Dense(120,activation='sigmoid',kernel_initializer='uniform'))
#model_classic_CNN.add(keras.layers.Dense(10,activation='sigmoid',kernel_initializer='uniform'))
