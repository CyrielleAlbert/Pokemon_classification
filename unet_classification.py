...
from tensorflow.keras.models import Sequential, Model, ModelCheckpoint
...
modelunet = unet(None,img_size,num_classes)
checkpoint = ModelCheckpoint(filepath, monotor='val_acc', verbose=1, save_best_only=True, mode='max')
hist = modelunet.fit(X_train,y_train,validation_data=(X_test,y_test),epochs=500,batch_size=32) #Changer nb epochs


# modelunet.summary()
# modelunet.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
# -------
# # Model CNN simple
